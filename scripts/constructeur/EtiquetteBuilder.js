...
export class EtiquetteBuilder {
  ...
  etiquetteLikePrix () {
    ...
    for (let i = 0; i < this.mediasIdIndex.length; i++) {
      ...
      totalCoeur.innerHTML = " <i class='fa-solid fa-heart'></i>"
      ...
      divClickLike.addEventListener('click', (e) => {
        ...
        if (clique) {
          ...
          likeTotalVerifierAuClique += 1; divLikes.textContent = `${this.mediasIdLike[i] + 1} `; divClickLike.innerHTML = " <i class='fa-solid fa-heart fa-heart-margin'></i>"
